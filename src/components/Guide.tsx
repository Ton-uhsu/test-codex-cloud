  ...
  return (
    <div className="content-wrap">
      ...
      <section className="panel">
        ...
        <p>
          โหมดทำไปพร้อมกันรองรับ Lateral Raise 1 ท่า ภาพ Goulart ผ่าน{" "}
          <a
            href="https://wger.de/media/exercise-video/348/de69928a-8a35-4096-821c-1f46de5e0e03.MOV"
            target="_blank"
            rel="noreferrer"
          >
            wger · ต้นฉบับ ↗
          ...
          ภาพปกมาจากเวลา 0.25 วินาที วิดีโอตัดช่วง 0.25–2.25 วินาที
          ลดความเร็วครึ่งหนึ่ง ย่อภาพและตัดเสียง
          ภาพที่ปรับและภาพปกเผยแพร่ภายใต้ใบอนุญาตเดียวกัน เสียงไทยขึ้นกับอุปกรณ์
          บางเสียงอาจใช้อินเทอร์เน็ต
        </p>
        <p>
          {data.program.audience} ไม่มีบัญชีผู้ใช้
          ไม่ประเมินท่าหรือสุขภาพเฉพาะบุคคล ความคืบหน้าฝึกอยู่ในหน้านี้
