import { escapeHTML as h, DAYS, workoutForDay, nextTrainingDay } from './guide.mjs?v=4';
import { GOALS, ACTIVITIES, calculateNutrition, NUTRITION_SOURCES, NUTRITION_REVIEWED_AT } from './nutrition.mjs?v=4';
import { buildMeals } from './meals.mjs?v=4';
