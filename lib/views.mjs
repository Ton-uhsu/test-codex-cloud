import { MUSCLES, escapeHTML as h, safeSourceURL, filterExercises } from './guide.mjs?v=4';
import { youtubeLinks, videoPreview } from './video.mjs?v=4';
import { workoutView } from './workout-views.mjs?v=4';
import { setupView, planView, nutritionView } from './profile-views.mjs?v=4';
