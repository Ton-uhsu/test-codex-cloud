import { DAYS, WEEK_ORDER, MUSCLES, escapeHTML as h, workoutForDay, nextTrainingDay } from './guide.mjs?v=4';
import { videoPreview, youtubeLinks } from './video.mjs?v=4';
import { remainingRest } from './session.mjs?v=4';
